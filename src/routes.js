      ...
      children: [
        {
          ...
          beforeEnter: (to, from, next) => {
            /*
              хук вызывается перед тем как зайти на текущий роут.
              Позволяет сделать защищённый роут для авторизованного пользователя.
              next - это функция, вызов которой разрешает хук и разрешает переход
              на текущий роут. Можно передать несколько параметров.
              Тут можно добавить проверку на авторизацию пользователя.
            */
